...
from dynamics.gnn import NUM_RIGHT_HAND_PARTICLES, RIGHT_HAND_EDGES
from dynamics.dataset import GNNDataset
from baseline.pcd_mlp import PointcloudEncoder
    ...
    for i in range(len(dataset)):
        ...
        for fi in range(dataset_config['n_future']):
            ...
            this_model_input = torch.cat([
                    this_particles.reshape(B, N, T * 3),   # (B, N, 3T)
                    this_actions,                       # (B, N, 3)
            ...
            hand_particles = this_gt_particles[-NUM_RIGHT_HAND_PARTICLES:] # (19, 3)
