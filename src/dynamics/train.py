...
from dynamics.gnn import GraphNeuralDynamics, NUM_RIGHT_HAND_PARTICLES
        ...
        for phase in phases:
            ...
            with torch.set_grad_enabled(phase == 'train'):
                ...
                for i in range(n_iters):
                    ...
                    # print(f"{particle_types.shape=}, {particles.shape=}, {actions.shape=}")
